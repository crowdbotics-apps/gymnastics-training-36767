...
## Project Structure
    ...
    ├── gymnastics_training_36767  # Django project configurations
...
1. Clone this repo and `cd gymnastics_training_36767`
...
2. Clone this repo and `cd gymnastics_training_36767`
